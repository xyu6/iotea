...
$(function() {
    ...
    vue = new Vue({
        ...
        methods: {
            ...
            t1: function () {
               this.touchstart1=true;
               this.touched1=false;
            },
            t11: function () {
               this.touchstart1=false;
               this.touched1=true;
               this.lwa=false;
               this.lgbtn1a=true;
               this.lgbtn2a=false;
            ...
            t2: function () {
               this.touchstart2=true;
               this.touched2=false;
            },
            t22: function () {
               this.touchstart2=false;
               this.touched2=true;
               this.lwa=false;
               this.lgbtn1a=false;
               this.lgbtn2a=false;
            ...
            t3: function () {
               this.touchstart3=true;
               this.touched3=false;
            },
            t33: function () {
                this.touchstart3=false;
                this.touched3=true;
                this.lwa=false;
                this.lgbtn1a=false;
                this.lgbtn2a=false;
                ...
                if(this.a.series[0].data==''){
                    setTimeout(function(){
                        ...
                        self.lgbtn4a=true;
                        self.lgbtn4aa=false;},3000);//测试几秒加载完成
                }else{
                    self.loadingfade=true ;//使用渐隐的方法淡出loading page
                    self.lgbtn4a=true;
                    self.lgbtn4aa=false;
            ...
            t5: function () {
               this.touchstart5=true;
               this.touched5=false;
            },
            t55: function () {
               this.touchstart5=false;
               this.touched5=true;
                this.lwa=false;
               this.lgbtn1a=false;
                this.lgbtn2a=false;
